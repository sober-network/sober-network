        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDaysSoberPublic = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    MailingPostalCode = table.Column<string>(type: "text", nullable: true),
                    MailingCountry = table.Column<string>(type: "text", nullable: true),
                    MailingLatitude = table.Column<double>(type: "double precision", nullable: true),
                    MailingLongitude = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Formats = table.Column<List<string>>(type: "text[]", nullable: false, defaultValueSql: "ARRAY[]::text[]"),
                    ...
                    PublicJoinUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    MeetingType = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPhoneShared = table.Column<bool>(type: "boolean", nullable: false),
