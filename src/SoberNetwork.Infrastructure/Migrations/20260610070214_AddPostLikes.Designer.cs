...
namespace SoberNetwork.Infrastructure.Migrations
{
    ...
    [Migration("20260610070214_AddPostLikes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoberNetwork.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SoberNetwork.Domain.Entities.PostLike", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SoberNetwork.Domain.Entities.PostMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SoberNetwork.Domain.Entities.Notification", b =>
                {
                    b.HasOne("SoberNetwork.Domain.Entities.PostComment", "Comment")
                        .WithMany()
                    ...
                    b.HasOne("SoberNetwork.Domain.Entities.ApplicationUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoberNetwork.Domain.Entities.ApplicationUser", "TriggerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SoberNetwork.Domain.Entities.PostMedia", b =>
                {
                    b.HasOne("SoberNetwork.Domain.Entities.PostComment", "Comment")
                        .WithOne("Media")
                        .HasForeignKey("SoberNetwork.Domain.Entities.PostMedia", "CommentId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("SoberNetwork.Domain.Entities.Post", "Post")
                        .WithOne("Media")
                        .HasForeignKey("SoberNetwork.Domain.Entities.PostMedia", "PostId")
                        .OnDelete(DeleteBehavior.Cascade);
